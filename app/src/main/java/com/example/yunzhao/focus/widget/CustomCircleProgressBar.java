...
/**
 * Created by Yunzhao on 2018/3/11.
 */
...
public class CustomCircleProgressBar extends View {
    ...
    public CustomCircleProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        insideColor = a.getColor(R.styleable.CustomCircleProgressBar_inside_color, ContextCompat.getColor(getContext(), R.color.progress_color));
    ...
    private String getProgressText() {
        int secondLeft = (int) (1500 - progress);
        int minute = secondLeft / 60;
        int second = secondLeft - 60*minute;
    ...
    private void startAnim(float startProgress) {
        if (startProgress == 0) {
            ...
            animator = ObjectAnimator.ofFloat(startProgress-1, startProgress);
        }
